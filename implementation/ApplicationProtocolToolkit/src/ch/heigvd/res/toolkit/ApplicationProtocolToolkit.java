...
//		interfaceController.startup();
      JsonReader jsonReader = Json.createReader(new StringReader("{\"MESSAGE_TYPE\" : \"FUNCTIONS_LIST\",\"FUNCTIONS\" : [{\"the name of a computing function\" : \"description of the computing function\",\"the name of another computing function\" : \"description of the computing function\"}]}"));
      JsonObject jsonObject = jsonReader.readObject();
      jsonReader.close();

      System.out.println(jsonObject.getString("MESSAGE_TYPE"));
	}
